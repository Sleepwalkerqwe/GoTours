...
var stripe = Stripe('pk_live_51QyIrJCZaY6vcesNs6XyDHCjXizHOlfyTwxNJ2B2bx3rg8fOUpmNhzqLtEMKj2jbQo1tbOvGPTEwDgUD83rZPnWj00wHKSexFY');
...
if (loginForm) {
  ...
  var forgotText = document.querySelector('#forgotText');
  forgotText.addEventListener('click', function (e) {
    console.log(123);
...
if (saveSettingsBtn) {
  saveSettingsBtn.addEventListener('click', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
